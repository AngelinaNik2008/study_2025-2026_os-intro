...
subtitle: "Текстровый редактор emacs"
license: "CC BY"
---
...
2. Создадим файл lab11.sh с помощью комбинации Ctrl-x Ctrl-f и наберем текст из задания в ново созданный файл.  
...
![Выделение блока](image/4.png){ #fig:006 width=70% height=70% }
...
![Удаление блока](image/6.png){ #fig:004 width=70% height=70% }
...
![Переключение буфера](image/7.png){ #fig:011 width=70% height=70% }

11.  Закроем это окно командой Ctrl-x 0.

![Закроем буфер](image/8.png){ #fig:012 width=70% height=70% }

12. Теперь вновь переключимся между буферами, но уже без вывода их списка на экран Ctrl-x b. 

13. Поделим фрейм на 2 части: разделитм фрейм на два окна по вертикали Ctrl-x 3, а затем каждое из этих окон на две части по горизонтали Ctrl-x 2. 
В каждом из четырёх созданных окон откроем новый буфер (файл).

![Два буфера](image/9.png){ #fig:014 width=70% height=70% }
...
![Режим поиска](image/10.png){ #fig:010 width=70% height=70% }
